<?php
    ...
    $page_title="View Stock in Reports | Stock Management System";
    include("./includes/pages/site/header.php");
?>

    <div class="tables">
        <div class="table-header">
        <h1> <i class="fas fa-list-ul icon-table"></i> View Stock in Reports</h1>
        </div>
        <div class="table">
        <table>
        <tr>
        ...
        <?php
            $stock_view=mysqli_query($con,"SELECT * FROM stock_in  WHERE p_price ORDER BY p_total_price ASC");
